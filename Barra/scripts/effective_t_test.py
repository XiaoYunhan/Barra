...
'''
# 导入股票收益率数据
#/Users/caterpillar/Desktop/indicators/Barra/Barra
folder_path = '../data/raw_data/日个股回报率/'
...
# 导入所有标准化因子数据和行业因子
factors_dict = {}
path = '../data/standardized_risk_factors/'
...
t_test_results.to_csv('../data/factor_effective_tests/T_Test_Results.csv', index=False)